...
public class ExpenseReporterPresenterImpl extends AbstractActivity implements ExpenseReporterPresenter {
  ...
  public void getMonthsOf(int year) {
    ...
    asynchService.dispatchSecurityAction(securityAction, new GotResponse<SecurityResponse<FetchMonthsResponse>>() {
      @Override
  ...
  public void getAllExpensesDays(int year, int month) {
    ...
    asynchService.dispatchSecurityAction(securityAction, new GotResponse<SecurityResponse<FetchDaysResponse>>() {
      @Override
